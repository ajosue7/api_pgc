...
@Entity
@Table(name = "tbl_programas_plan_nacion",
        indexes = {@Index(name = "idx_codigo_programa_plan_nacion", columnList = "CODIGO_PROGRAMA")},
        uniqueConstraints = {@UniqueConstraint(columnNames = {"CODIGO_PROGRAMA"})})
public class TblProgramaPlanNacion {
    ...
    @ApiModelProperty(notes = "Codigo Plan Nacion", required = true)
    ...
    @ApiModelProperty(notes = "Entidad del Plan de Nacion, se envia desde un Json (\"programaPadreId\": { \"idPrograma\": \"valor\" })",
            required = true)
    private TblProgramaPlanNacion programaPadreId;
    ...
    public TblProgramaPlanNacion getProgramaPadreId() {
        return programaPadreId;
    }

    public void setProgramaPadreId(TblProgramaPlanNacion programaPadreId) {
