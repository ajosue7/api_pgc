...
@Entity
@Table(name = "tbl_programas_vida_mejor",
        indexes = {@Index(name = "idx_codigo_programa_vida_mejor", columnList = "CODIGO_PROGRAMA")},
        uniqueConstraints = {@UniqueConstraint(columnNames = {"CODIGO_PROGRAMA"})})
public class TblProgramaVidaMejor {
    ...
    @ApiModelProperty(notes = "Entidad del Plan de Nacion, se envia desde un Json (\"programaPadreId\": { \"idPrograma\": \"valor\" })",
            required = true)
    private TblProgramaVidaMejor programaPadreId;
    ...
    public TblProgramaVidaMejor getProgramaPadreId() {
        return programaPadreId;
    }

    public void setProgramaPadreId(TblProgramaVidaMejor programaPadreId) {
