...
@Entity
@Table(name = "tbl_sectores_ods",
        indexes = {@Index(name = "idx_codigo_sector_ods", columnList = "CODIGO_SECTOR")},
        uniqueConstraints = {@UniqueConstraint(columnNames = {"CODIGO_SECTOR"})})
public class TblSectorOds {
    ...
    @ApiModelProperty(notes = "Codigo Sector ODS", required = true)
    private String codigoSector;

    @Column(name = "NOMBRE_SECTOR", nullable = false, length = 250)
    @ApiModelProperty(notes = "Nombre del Sector ODS")
    private String nombreSector;

    @Column(name = "DESCRIPCION_SECTOR", nullable = false, length = 250)
    @ApiModelProperty(notes = "Descripcion del Sector ODS")
    private String descripcionSector;

    @Column(name = "IMAGEN_SECTOR", nullable = false, length = 300)
    @ApiModelProperty(notes = "Imagen del Sector ODS")
    private String imagenSector;

    @Column(name = "AYUDA_SECTOR", nullable = false, length = 300)
    @ApiModelProperty(notes = "Material de ayuda para el Sector/ODS")
    private String ayudaSector;
    ...
    @ApiModelProperty(notes = "Entidad del Sector OCDE, se envia desde un Json (\"sectorPadreId\": { \"idSector\": \"valor\" })",
            required = true)
    private TblSectorOds sectorPadreId;
    ...
    public TblSectorOds getSectorPadreId() {
        return sectorPadreId;
    }

    public void setSectorPadreId(TblSectorOds sectorPadreId) {
    ...
    public String getAyudaSector() {
        return ayudaSector;
    }

    public void setAyudaSector(String ayudaSector) {
        this.ayudaSector = ayudaSector;
    }
}
