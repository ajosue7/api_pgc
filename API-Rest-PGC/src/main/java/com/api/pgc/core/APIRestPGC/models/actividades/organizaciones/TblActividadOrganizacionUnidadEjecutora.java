...
@Entity
@Table(name = "tbl_actividades_unidad_ejecutora",
        indexes = {@Index(name = "idx_codigo_actividad_org_unidad_ejecutora", columnList = "CODIGO_ACTIVIDAD")},
        uniqueConstraints = {@UniqueConstraint(columnNames = {"CODIGO_ACTIVIDAD"})})
public class TblActividadOrganizacionUnidadEjecutora {
    // Propiedades de la tabla
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "ID_ACTIVIDAD_UNIDAD_EJECUTORA", columnDefinition = "serial")
    @ApiModelProperty(notes = "Identificador de la Tabla, se Autogenera")
    private long idActividadUnidadEjecutora;
     ...
     */
    public TblActividadOrganizacionUnidadEjecutora() {
     ...
     */
    public long getIdActividadUnidadEjecutora() {
        return idActividadUnidadEjecutora;
    }

    public void setIdActividadUnidadEjecutora(long idActividadUnidadEjecutora) {
        this.idActividadUnidadEjecutora = idActividadUnidadEjecutora;
    }
