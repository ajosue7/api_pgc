...
@Entity
@Table(name = "tbl_sectores_gobierno",
...
public class TblSectorGobierno {
    ...
    @ApiModelProperty(notes = "Entidad del Sector Gobierno, se envia desde un Json (\"sectorPadreId\": { \"idSector\": \"valor\" })",
            required = true)
    private TblSectorGobierno sectorPadreId;
    ...
    @ApiModelProperty(notes = "Entidad del Nivel de Sector Gobierno, se envia desde un Json (\"idNivelSector\": { \"idNivelSector\": \"valor\" })",
            required = true)
    ...
    public TblSectorGobierno getSectorPadreId() {
        return sectorPadreId;
    }

    public void setSectorPadreId(TblSectorGobierno sectorPadreId) {
