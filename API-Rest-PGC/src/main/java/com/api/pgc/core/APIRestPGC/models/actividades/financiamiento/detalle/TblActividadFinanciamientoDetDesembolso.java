...
@Entity
@Table(name = "tbl_actividades_financiamiento_det_desembolsos",
        indexes = {@Index(name = "idx_codigo_financ_DESEMBOLSO", columnList = "CODIGO_FINANC_DESEMBOLSO")},
        uniqueConstraints = {@UniqueConstraint(columnNames = {"CODIGO_FINANC_DESEMBOLSO"})})
@SequenceGenerator( name = "tbl_actividades_financiamiento_det_desembolso_id_actividad_fina", sequenceName = "tbl_actividades_financiamiento_det_desembolso_id_actividad_fina", initialValue = 1, allocationSize = 1)
public class TblActividadFinanciamientoDetDesembolso {
    // Propiedades de la tabla
    @Id
    //@GeneratedValue(strategy = GenerationType.IDENTITY)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tbl_actividades_financiamiento_det_desembolso_id_actividad_fina")
    @Column(name = "ID_ACTIVIDAD_FINANC_DET_DESEMBOLSO", columnDefinition = "serial")
    @ApiModelProperty(notes = "Identificador de la Tabla, se Autogenera")
    private long idActividadFinancDetDesembolso;

    @Column(name = "CODIGO_FINANC_DESEMBOLSO", nullable = false, length = 50)
    @ApiModelProperty(notes = "Codigo de la Transacción", required = true)
    private String codigoFinancDesembolso;
     ...
     */
    public TblActividadFinanciamientoDetDesembolso() {
     ...
     */
    public long getIdActividadFinancDetDesembolso() {
        return idActividadFinancDetDesembolso;
    }

    public void setIdActividadFinancDetDesembolso(long idActividadFinancDetDesembolso) {
        this.idActividadFinancDetDesembolso = idActividadFinancDetDesembolso;
    }

    public String getCodigoFinancDesembolso() {
        return codigoFinancDesembolso;
    }

    public void setCodigoFinancDesembolso(String codigoFinancDesembolso) {
        this.codigoFinancDesembolso = codigoFinancDesembolso;
    }
