...
@Entity
@Table(name = "tbl_programas_politicas_publicas",
        indexes = {@Index(name = "idx_codigo_programa_politica_publica", columnList = "CODIGO_PROGRAMA")},
        uniqueConstraints = {@UniqueConstraint(columnNames = {"CODIGO_PROGRAMA"})})
public class TblProgramaPoliticaPublica {
    ...
    @ApiModelProperty(notes = "Codigo Politica Pública", required = true)
    ...
    @ApiModelProperty(notes = "Entidad del Plan de Nacion, se envia desde un Json (\"programaPadreId\": { \"idPrograma\": \"valor\" })",
            required = true)
    private TblProgramaPoliticaPublica programaPadreId;
     ...
     */
    public TblProgramaPoliticaPublica() {
    }
    ...
    public TblProgramaPoliticaPublica getProgramaPadreId() {
        return programaPadreId;
    }

    public void setProgramaPadreId(TblProgramaPoliticaPublica programaPadreId) {
